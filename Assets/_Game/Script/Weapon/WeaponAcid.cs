...
public class WeaponAcid : Weapon
{
    ...
    public override void Shooting(Character character, Vector3 target)
    {
        ...
        {
            float spreadAngle = Random.Range(-Angle/2, Angle/2); // Góc phân tán 
            Quaternion spreadRotation = Quaternion.Euler(0f, spreadAngle, spreadAngle); // Quay hướng phân tán
